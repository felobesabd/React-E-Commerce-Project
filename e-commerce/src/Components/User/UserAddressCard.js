...
import DeleteUserAddressHook from "./../../hook/user/delete-user-address-hook";
const UserAddressCard = ({ item }) => {
  const [show, handleClose, handleShow, handleDelete] = DeleteUserAddressHook(
    item._id
  );
    ...
    <div className="user-address-card px-2 my-3">
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body style={{ backgroundColor: "#f9f9f9" }}>
          <div className="onlyfont">هل أنت متأكد من حذف العنوان؟</div>
        </Modal.Body>
        <Modal.Footer>
